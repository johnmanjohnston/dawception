...
#define UI_INSTRUCTION_CLEAR_ALL_CLIP_COMPONENTS 0xa3
...
#define UI_INSTRUCTION_CLOSE_CPWS_WITH_ROUTE 0xc0
...
#define UI_INSTRUCTION_UPDATE_DISPLAYED_LATENCY 0xb1
